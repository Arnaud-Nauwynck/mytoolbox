...
*/
// Code duplicated in fr.an.com.sun.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // In fr.an.java.ejavac.jvm.Gen.genCatch we first set the type_index
    // to the catch type index - that value is only temporary.
    // Then in fr.an.java.ejavac.jvm.Code.fillExceptionParameterPositions
