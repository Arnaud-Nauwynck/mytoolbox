...
package fr.an.com.sun.tools.javac.comp;

import static fr.an.com.sun.tools.javac.code.Flags.ABSTRACT;
import static fr.an.com.sun.tools.javac.code.Flags.ANNOTATION;
import static fr.an.com.sun.tools.javac.code.Flags.BLOCK;
import static fr.an.com.sun.tools.javac.code.Flags.COMPOUND;
import static fr.an.com.sun.tools.javac.code.Flags.DEFAULT;
import static fr.an.com.sun.tools.javac.code.Flags.ENUM;
import static fr.an.com.sun.tools.javac.code.Flags.FINAL;
import static fr.an.com.sun.tools.javac.code.Flags.GENERATEDCONSTR;
import static fr.an.com.sun.tools.javac.code.Flags.HASINIT;
import static fr.an.com.sun.tools.javac.code.Flags.INTERFACE;
import static fr.an.com.sun.tools.javac.code.Flags.NATIVE;
import static fr.an.com.sun.tools.javac.code.Flags.NOOUTERTHIS;
import static fr.an.com.sun.tools.javac.code.Flags.PARAMETER;
import static fr.an.com.sun.tools.javac.code.Flags.PUBLIC;
import static fr.an.com.sun.tools.javac.code.Flags.SIGNATURE_POLYMORPHIC;
...
import static fr.an.com.sun.tools.javac.code.Flags.UNATTRIBUTED;
import static fr.an.com.sun.tools.javac.code.Flags.UNION;
import static fr.an.com.sun.tools.javac.code.Kinds.ABSENT_MTH;
import static fr.an.com.sun.tools.javac.code.Kinds.ABSENT_TYP;
import static fr.an.com.sun.tools.javac.code.Kinds.AMBIGUOUS;
import static fr.an.com.sun.tools.javac.code.Kinds.ERR;
import static fr.an.com.sun.tools.javac.code.Kinds.HIDDEN;
import static fr.an.com.sun.tools.javac.code.Kinds.MISSING_ENCL;
import static fr.an.com.sun.tools.javac.code.Kinds.MTH;
import static fr.an.com.sun.tools.javac.code.Kinds.NIL;
import static fr.an.com.sun.tools.javac.code.Kinds.PCK;
import static fr.an.com.sun.tools.javac.code.Kinds.POLY;
import static fr.an.com.sun.tools.javac.code.Kinds.STATICERR;
import static fr.an.com.sun.tools.javac.code.Kinds.TYP;
import static fr.an.com.sun.tools.javac.code.Kinds.VAL;
import static fr.an.com.sun.tools.javac.code.Kinds.VAR;
import static fr.an.com.sun.tools.javac.code.Kinds.WRONG_MTH;
import static fr.an.com.sun.tools.javac.code.Kinds.WRONG_MTHS;
import static fr.an.com.sun.tools.javac.code.Kinds.kindName;
import static fr.an.com.sun.tools.javac.code.Kinds.kindNames;
...
import static fr.an.com.sun.tools.javac.code.TypeTag.FORALL;
import static fr.an.com.sun.tools.javac.code.TypeTag.INT;
import static fr.an.com.sun.tools.javac.code.TypeTag.LONG;
import static fr.an.com.sun.tools.javac.code.TypeTag.METHOD;
import static fr.an.com.sun.tools.javac.code.TypeTag.NONE;
import static fr.an.com.sun.tools.javac.code.TypeTag.SHORT;
import static fr.an.com.sun.tools.javac.code.TypeTag.TYPEVAR;
...
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.NULLCHK;
...
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPE_ANNOTATION;
...
import fr.an.com.sun.source.util.SimpleTreeVisitor;
import fr.an.com.sun.tools.javac.code.Attribute;
import fr.an.com.sun.tools.javac.code.BoundKind;
import fr.an.com.sun.tools.javac.code.DeferredLintHandler;
import fr.an.com.sun.tools.javac.code.Flags;
import fr.an.com.sun.tools.javac.code.Kinds;
import fr.an.com.sun.tools.javac.code.Lint;
import fr.an.com.sun.tools.javac.code.Lint.LintCategory;
...
import fr.an.com.sun.tools.javac.code.Type.AnnotatedType;
import fr.an.com.sun.tools.javac.code.Type.ArrayType;
import fr.an.com.sun.tools.javac.code.Type.ClassType;
import fr.an.com.sun.tools.javac.code.Type.ForAll;
import fr.an.com.sun.tools.javac.code.Type.IntersectionClassType;
import fr.an.com.sun.tools.javac.code.Type.MethodType;
import fr.an.com.sun.tools.javac.code.Type.TypeVar;
import fr.an.com.sun.tools.javac.code.Type.UnionClassType;
import fr.an.com.sun.tools.javac.code.Type.WildcardType;
import fr.an.com.sun.tools.javac.code.TypeAnnotations;
import fr.an.com.sun.tools.javac.code.TypeTag;
import fr.an.com.sun.tools.javac.code.Types;
import fr.an.com.sun.tools.javac.comp.Check.CheckContext;
import fr.an.com.sun.tools.javac.comp.DeferredAttr.AttrMode;
import fr.an.com.sun.tools.javac.comp.Infer.FreeTypeListener;
import fr.an.com.sun.tools.javac.comp.Infer.InferenceContext;
import fr.an.com.sun.tools.javac.jvm.ByteCodes;
import fr.an.com.sun.tools.javac.jvm.Target;
...
import fr.an.com.sun.tools.javac.tree.TreeTranslator;
...
import fr.an.com.sun.tools.javac.util.Warner;
...
//                             Resolve.isStatic(env));//DEBUG
    ...
    private final JCTree.Visitor typeAnnotationsValidator = new TreeScanner() {
         ...
         * fr.an.java.ejavac.comp.Check.Validator.visitSelectInternal(JCFieldAccess)
