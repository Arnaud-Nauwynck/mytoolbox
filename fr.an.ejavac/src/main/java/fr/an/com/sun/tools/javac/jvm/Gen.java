...
package fr.an.com.sun.tools.javac.jvm;
import static fr.an.com.sun.tools.javac.code.Flags.ABSTRACT;
import static fr.an.com.sun.tools.javac.code.Flags.FINAL;
import static fr.an.com.sun.tools.javac.code.Flags.INTERFACE;
import static fr.an.com.sun.tools.javac.code.Flags.IPROXY;
import static fr.an.com.sun.tools.javac.code.Flags.PRIVATE;
import static fr.an.com.sun.tools.javac.code.Flags.STATIC;
import static fr.an.com.sun.tools.javac.code.Flags.STRICTFP;
import static fr.an.com.sun.tools.javac.code.Flags.SYNTHETIC;
...
import static fr.an.com.sun.tools.javac.code.TypeTag.ARRAY;
import static fr.an.com.sun.tools.javac.code.TypeTag.BOT;
...
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.BYTEcode;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.CHARcode;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.DOUBLEcode;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.FLOATcode;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.INTcode;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.LONGcode;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.SHORTcode;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.aconst_null;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.arraylength;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.athrow;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.checkcast;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.dconst_0;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.dontgoto;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.dup;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.dup_x1;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.fconst_0;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.goto_;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.iadd;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.iconst_0;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.iconst_m1;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.if_acmp_nonnull;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.if_acmp_null;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.if_acmpeq;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.if_acmpne;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.if_icmpeq;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.if_icmple;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.ifeq;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.instanceof_;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.int2byte;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.ireturn;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.ishl;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.ishll;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.isub;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.jsr;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.lconst_0;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.lookupswitch;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.lushrl;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.monitorenter;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.monitorexit;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.new_;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.pop;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.preShift;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.ret;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.return_;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.string_add;
import static fr.an.com.sun.tools.javac.jvm.ByteCodes.tableswitch;
import static fr.an.com.sun.tools.javac.jvm.CRTFlags.CRT_BLOCK;
import static fr.an.com.sun.tools.javac.jvm.CRTFlags.CRT_FLOW_CONTROLLER;
import static fr.an.com.sun.tools.javac.jvm.CRTFlags.CRT_FLOW_TARGET;
import static fr.an.com.sun.tools.javac.jvm.CRTFlags.CRT_STATEMENT;
import static fr.an.com.sun.tools.javac.main.Option.G;
import static fr.an.com.sun.tools.javac.main.Option.G_CUSTOM;
import static fr.an.com.sun.tools.javac.main.Option.XJCOV;
...
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.PLUS;
...
import fr.an.com.sun.tools.javac.code.Attribute.TypeCompound;
...
import fr.an.com.sun.tools.javac.code.Symbol.CompletionFailure;
import fr.an.com.sun.tools.javac.code.Symbol.MethodSymbol;
import fr.an.com.sun.tools.javac.code.Symbol.OperatorSymbol;
...
import fr.an.com.sun.tools.javac.code.TargetType;
import fr.an.com.sun.tools.javac.code.Type;
import fr.an.com.sun.tools.javac.code.Type.MethodType;
import fr.an.com.sun.tools.javac.code.Types;
import fr.an.com.sun.tools.javac.comp.AttrContext;
import fr.an.com.sun.tools.javac.comp.Check;
import fr.an.com.sun.tools.javac.comp.Env;
import fr.an.com.sun.tools.javac.comp.Lower;
import fr.an.com.sun.tools.javac.comp.Resolve;
import fr.an.com.sun.tools.javac.jvm.Code.Chain;
import fr.an.com.sun.tools.javac.jvm.Code.StackMapFormat;
import fr.an.com.sun.tools.javac.jvm.Items.CondItem;
import fr.an.com.sun.tools.javac.jvm.Items.Item;
import fr.an.com.sun.tools.javac.jvm.Items.LocalItem;
...
import fr.an.com.sun.tools.javac.tree.TreeScanner;
...
import fr.an.com.sun.tools.javac.util.Options;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        for (Symbol s : new fr.an.com.sun.tools.javac.model.FilteredMemberList(clazz.members())) {
