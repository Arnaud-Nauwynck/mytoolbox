...
package fr.an.com.sun.tools.javac.sym;

import fr.an.com.sun.tools.javac.api.JavacTaskImpl;
 ...
 *
 * <dl>
 * <dt>fr.an.java.ejavac.sym.Jar</dt>
 * <dd>Specifies the location of rt.jar.</dd>
 * <dt>fr.an.java.ejavac.sym.Dest</dt>
 ...
 */
@SupportedOptions({
    "fr.an.java.ejavac.sym.Jar",
    "fr.an.java.ejavac.sym.Dest",
    "fr.an.java.ejavac.sym.Profiles"})
@SupportedAnnotationTypes("*")
public class CreateSymbols extends AbstractProcessor {

    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
            = ResourceBundle.getBundle("fr.an.java.ejavac.resources.legacy");
    ...
    void createSymbols() throws IOException {
        ...
        String jarName = pOptions.get("fr.an.java.ejavac.sym.Jar");
        if (jarName == null)
            throw new RuntimeException("Must use -Afr.an.java.ejavac.sym.Jar=LOCATION_OF_JAR");
        String destName = pOptions.get("fr.an.java.ejavac.sym.Dest");
        if (destName == null)
            throw new RuntimeException("Must use -Afr.an.java.ejavac.sym.Dest=LOCATION_OF_JAR");
        String profileSpec=pOptions.get("fr.an.java.ejavac.sym.Profiles");
        if (profileSpec == null)
            throw new RuntimeException("Must use -Afr.an.java.ejavac.sym.Profiles=PROFILES_SPEC");
        ...
        fr.an.com.sun.tools.javac.main.JavaCompiler compiler =
            fr.an.com.sun.tools.javac.main.JavaCompiler.instance(task.getContext());
    ...
    public static void main(String... args) {
        ...
        args = new String[] {
            ...
            "-proc:only",
            "-processor",
            "fr.an.java.ejavac.sym.CreateSymbols",
            "-Afr.an.java.ejavac.sym.Jar=" + rt_jar,
            "-Afr.an.java.ejavac.sym.Dest=" + dest,
        ...
        fr.an.com.sun.tools.javac.Main.compile(args);
    }
