...
package fr.an.com.sun.tools.javac.file;
...
import fr.an.com.sun.tools.javac.file.RelativePath.RelativeDirectory;
import fr.an.com.sun.tools.javac.file.RelativePath.RelativeFile;
...
public class ZipFileIndex {
     ...
     */
    public synchronized fr.an.com.sun.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            fr.an.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return fr.an.com.sun.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            fr.an.com.sun.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private fr.an.com.sun.tools.javac.util.List<String> zipFileEntriesFiles = fr.an.com.sun.tools.javac.util.List.<String>nil();
        private fr.an.com.sun.tools.javac.util.List<String> zipFileEntriesDirectories = fr.an.com.sun.tools.javac.util.List.<String>nil();
        private fr.an.com.sun.tools.javac.util.List<Entry>  zipFileEntries = fr.an.com.sun.tools.javac.util.List.<Entry>nil();
        ...
        private fr.an.com.sun.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private fr.an.com.sun.tools.javac.util.List<String> getDirectories() {
        ...
        private fr.an.com.sun.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = fr.an.com.sun.tools.javac.util.List.nil();
