...
package fr.an.com.sun.tools.javac;
...
public class Main {
    ...
    public static int compile(String[] args) {
        fr.an.com.sun.tools.javac.main.Main compiler =
            new fr.an.com.sun.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        fr.an.com.sun.tools.javac.main.Main compiler =
            new fr.an.com.sun.tools.javac.main.Main("javac", out);
        return compiler.compile(args).exitCode;
    }
}
