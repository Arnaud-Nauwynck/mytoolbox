...
package fr.an.com.sun.tools.javac.api;
...
import fr.an.com.sun.source.doctree.DocCommentTree;
import fr.an.com.sun.source.doctree.DocTree;
import fr.an.com.sun.source.tree.CatchTree;
import fr.an.com.sun.source.tree.CompilationUnitTree;
import fr.an.com.sun.source.tree.Scope;
import fr.an.com.sun.source.tree.Tree;
import fr.an.com.sun.source.util.DocSourcePositions;
import fr.an.com.sun.source.util.DocTreePath;
import fr.an.com.sun.source.util.DocTreeScanner;
import fr.an.com.sun.source.util.DocTrees;
import fr.an.com.sun.source.util.JavacTask;
import fr.an.com.sun.source.util.TreePath;
...
import fr.an.com.sun.tools.javac.code.Types.TypeRelation;
import fr.an.com.sun.tools.javac.comp.Attr;
import fr.an.com.sun.tools.javac.comp.AttrContext;
import fr.an.com.sun.tools.javac.comp.Enter;
import fr.an.com.sun.tools.javac.comp.Env;
import fr.an.com.sun.tools.javac.comp.MemberEnter;
import fr.an.com.sun.tools.javac.comp.Resolve;
import fr.an.com.sun.tools.javac.model.JavacElements;
import fr.an.com.sun.tools.javac.processing.JavacProcessingEnvironment;
import fr.an.com.sun.tools.javac.tree.DCTree;
import fr.an.com.sun.tools.javac.tree.EndPosTable;
import fr.an.com.sun.tools.javac.tree.JCTree;
import fr.an.com.sun.tools.javac.tree.TreeCopier;
import fr.an.com.sun.tools.javac.tree.TreeInfo;
import fr.an.com.sun.tools.javac.tree.TreeMaker;
import fr.an.com.sun.tools.javac.tree.DCTree.DCBlockTag;
import fr.an.com.sun.tools.javac.tree.DCTree.DCDocComment;
import fr.an.com.sun.tools.javac.tree.DCTree.DCEndPosTree;
import fr.an.com.sun.tools.javac.tree.DCTree.DCErroneous;
import fr.an.com.sun.tools.javac.tree.DCTree.DCIdentifier;
import fr.an.com.sun.tools.javac.tree.DCTree.DCParam;
import fr.an.com.sun.tools.javac.tree.DCTree.DCReference;
import fr.an.com.sun.tools.javac.tree.DCTree.DCText;
import fr.an.com.sun.tools.javac.tree.JCTree.*;
...
import static fr.an.com.sun.tools.javac.code.TypeTag.*;
...
public class JavacTrees extends DocTrees {
    ...
    private VarSymbol searchField(ClassSymbol tsym, Name fieldName, Set<ClassSymbol> searched) {
        ...
        for (fr.an.com.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(fieldName);
    ...
    /** @see fr.an.com.sun.tools.javadoc.ClassDocImpl#findConstructor */
    MethodSymbol findConstructor(ClassSymbol tsym, List<Type> paramTypes) {
        for (fr.an.com.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(names.init);
                e.scope != null; e = e.next()) {
    ...
    /** @see fr.an.com.sun.tools.javadoc.ClassDocImpl#findMethod */
    ...
    /** @see fr.an.com.sun.tools.javadoc.ClassDocImpl#searchMethod */
    private MethodSymbol searchMethod(ClassSymbol tsym, Name methodName,
        ...
        fr.an.com.sun.tools.javac.code.Scope.Entry e = tsym.members().lookup(methodName);
    ...
    /** @see fr.an.com.sun.tools.javadoc.ClassDocImpl */
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof fr.an.com.sun.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (fr.an.com.sun.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
    ...
    public TypeMirror getOriginalType(javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof fr.an.com.sun.tools.javac.code.Type.ErrorType) {
            return ((fr.an.com.sun.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return fr.an.com.sun.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            fr.an.com.sun.source.tree.Tree t,
            fr.an.com.sun.source.tree.CompilationUnitTree root) {
        printMessage(kind, msg, ((JCTree) t).pos(), root);
    }

    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            fr.an.com.sun.source.doctree.DocTree t,
            fr.an.com.sun.source.doctree.DocCommentTree c,
            fr.an.com.sun.source.tree.CompilationUnitTree root) {
