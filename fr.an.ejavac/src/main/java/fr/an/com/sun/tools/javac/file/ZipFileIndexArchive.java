...
import fr.an.com.sun.tools.javac.file.JavacFileManager.Archive;
...
public class ZipFileIndexArchive implements Archive {
    ...
    /**
     * A subclass of JavaFileObject representing zip entries using the fr.an.java.ejavac.file.ZipFileIndex implementation.
     */
