...
package fr.an.com.sun.tools.javac.parser;

import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.AMP;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.ARROW;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.ASSERT;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.BAR;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.CASE;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.CATCH;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.CLASS;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.COLCOL;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.COLON;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.COMMA;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.DEFAULT;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.DOT;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.ELLIPSIS;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.ELSE;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.ENUM;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.EOF;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.EQ;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.EXTENDS;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.FINAL;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.FINALLY;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.GT;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.GTGTGTEQ;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.IDENTIFIER;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.IMPLEMENTS;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.IMPORT;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.INSTANCEOF;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.INTERFACE;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.INTLITERAL;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.LBRACE;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.LBRACKET;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.LONGLITERAL;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.LPAREN;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.LT;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.MONKEYS_AT;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.NEW;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.PACKAGE;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.PLUSEQ;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.PLUSPLUS;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.QUES;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.RBRACE;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.RBRACKET;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.RPAREN;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.SEMI;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.STAR;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.STATIC;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.SUB;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.SUBSUB;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.SUPER;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.THIS;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.THROWS;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.TRUE;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.UNDERSCORE;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.VOID;
import static fr.an.com.sun.tools.javac.parser.Tokens.TokenKind.WHILE;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.AND;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.BITAND;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.BITAND_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.BITOR;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.BITOR_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.BITXOR;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.BITXOR_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.COMPL;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.DIV;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.DIV_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.GE;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.IDENT;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.LE;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.LITERAL;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.MINUS;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.MINUS_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.MOD;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.MOD_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.MUL;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.MUL_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.NE;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.NEG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.NOT;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.NO_TAG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.OR;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.PLUS_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.POS;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.POSTDEC;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.POSTINC;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.PREDEC;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.PREINC;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.SELECT;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.SL;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.SL_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.SR;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.SR_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPEAPPLY;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPEARRAY;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPETEST;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.USR;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.USR_ASG;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.VARDEF;
import static fr.an.com.sun.tools.javac.util.ListBuffer.lb;
...
import fr.an.com.sun.tools.javac.code.Source;
import fr.an.com.sun.tools.javac.code.TypeTag;
import fr.an.com.sun.tools.javac.parser.Tokens.Comment;
import fr.an.com.sun.tools.javac.parser.Tokens.Comment.CommentStyle;
import fr.an.com.sun.tools.javac.parser.Tokens.Token;
import fr.an.com.sun.tools.javac.parser.Tokens.TokenKind;
import fr.an.com.sun.tools.javac.tree.DocCommentTable;
import fr.an.com.sun.tools.javac.tree.EndPosTable;
...
import fr.an.com.sun.tools.javac.tree.TreeInfo;
import fr.an.com.sun.tools.javac.tree.TreeMaker;
import fr.an.com.sun.tools.javac.util.Assert;
import fr.an.com.sun.tools.javac.util.Convert;
import fr.an.com.sun.tools.javac.util.Filter;
import fr.an.com.sun.tools.javac.util.JCDiagnostic;
import fr.an.com.sun.tools.javac.util.JCDiagnostic.DiagnosticFlag;
...
import fr.an.com.sun.tools.javac.util.Log;
        ...
        if (token.kind == LBRACKET || token.kind == MONKEYS_AT) {
            ...
            if (newClass.def != null) {
                ...
                if (newAnnotations.nonEmpty()) {
                    ...
                    // fr.an.java.ejavac.code.TypeAnnotations.TypeAnnotationPositions.visitNewClass(JCNewClass)
