...
import fr.an.com.sun.tools.javac.code.Type.UndetVar;
import fr.an.com.sun.tools.javac.code.Type.Visitor;
import fr.an.com.sun.tools.javac.code.Type.WildcardType;
import fr.an.com.sun.tools.javac.code.TypeAnnotationPosition.TypePathEntry;
import fr.an.com.sun.tools.javac.code.TypeAnnotationPosition.TypePathEntryKind;
...
import fr.an.com.sun.tools.javac.comp.Annotate.Annotator;
...
public class TypeAnnotations {
    ...
    private static class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link fr.an.java.ejavac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
        ...
        private static Type typeWithAnnotations(final JCTree typetree, final Type type,
            ...
            if (type.hasTag(TypeTag.ARRAY)) {
                ...
                // UnionClassType uct = (fr.an.java.ejavac.code.Type.UnionClassType)type;
        ...
        private void resolveFrame(JCTree tree, JCTree frame,
            ...
            */
            ...
            // fr.an.java.ejavac.jvm.Gen.setTypeAnnotationPositions(int)
