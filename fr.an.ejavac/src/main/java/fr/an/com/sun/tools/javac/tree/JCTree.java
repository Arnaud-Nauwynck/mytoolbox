...
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.ANNOTATED_TYPE;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.APPLY;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.ASSERT;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.ASSIGN;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.AST_ANNOTATION;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.BLOCK;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.BREAK;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.CASE;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.CATCH;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.CLASSDEF;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.CONDEXPR;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.CONTINUE;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.DOLOOP;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.ERRONEOUS;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.EXEC;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.FOREACHLOOP;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.FORLOOP;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.IDENT;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.IF;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.IMPORT;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.INDEXED;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.LABELLED;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.LAMBDA;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.LETEXPR;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.LITERAL;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.METHODDEF;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.MODIFIERS;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.NEWARRAY;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.NEWCLASS;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.PARENS;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.REFERENCE;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.RETURN;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.SELECT;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.SKIP;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.SWITCH;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.SYNCHRONIZED;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.THROW;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TOPLEVEL;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TRY;
...
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPEBOUNDKIND;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPECAST;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPEIDENT;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPEINTERSECTION;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPEPARAMETER;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPETEST;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.TYPEUNION;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.VARDEF;
import static fr.an.com.sun.tools.javac.tree.JCTree.Tag.WHILELOOP;
...
import fr.an.com.sun.source.tree.ASTAnnotationTree;
import fr.an.com.sun.source.tree.ASTExtensionTree;
import fr.an.com.sun.source.tree.AnnotationTree;
import fr.an.com.sun.source.tree.ArrayAccessTree;
import fr.an.com.sun.source.tree.ArrayTypeTree;
import fr.an.com.sun.source.tree.AssertTree;
import fr.an.com.sun.source.tree.AssignmentTree;
import fr.an.com.sun.source.tree.BinaryTree;
import fr.an.com.sun.source.tree.BlockTree;
import fr.an.com.sun.source.tree.BreakTree;
import fr.an.com.sun.source.tree.CaseTree;
import fr.an.com.sun.source.tree.CatchTree;
import fr.an.com.sun.source.tree.ClassTree;
import fr.an.com.sun.source.tree.CompilationUnitTree;
import fr.an.com.sun.source.tree.CompoundAssignmentTree;
import fr.an.com.sun.source.tree.ConditionalExpressionTree;
import fr.an.com.sun.source.tree.ContinueTree;
import fr.an.com.sun.source.tree.DoWhileLoopTree;
import fr.an.com.sun.source.tree.EmptyStatementTree;
import fr.an.com.sun.source.tree.EnhancedForLoopTree;
import fr.an.com.sun.source.tree.ExpressionStatementTree;
import fr.an.com.sun.source.tree.ExpressionTree;
import fr.an.com.sun.source.tree.ForLoopTree;
import fr.an.com.sun.source.tree.IdentifierTree;
import fr.an.com.sun.source.tree.IfTree;
import fr.an.com.sun.source.tree.ImportTree;
import fr.an.com.sun.source.tree.InstanceOfTree;
import fr.an.com.sun.source.tree.IntersectionTypeTree;
import fr.an.com.sun.source.tree.LabeledStatementTree;
import fr.an.com.sun.source.tree.LambdaExpressionTree;
import fr.an.com.sun.source.tree.LiteralTree;
import fr.an.com.sun.source.tree.MemberReferenceTree;
import fr.an.com.sun.source.tree.MemberSelectTree;
import fr.an.com.sun.source.tree.MethodInvocationTree;
import fr.an.com.sun.source.tree.MethodTree;
import fr.an.com.sun.source.tree.NewArrayTree;
import fr.an.com.sun.source.tree.NewClassTree;
import fr.an.com.sun.source.tree.ParameterizedTypeTree;
import fr.an.com.sun.source.tree.ParenthesizedTree;
import fr.an.com.sun.source.tree.PrimitiveTypeTree;
import fr.an.com.sun.source.tree.ReturnTree;
import fr.an.com.sun.source.tree.StatementTree;
import fr.an.com.sun.source.tree.SwitchTree;
import fr.an.com.sun.source.tree.SynchronizedTree;
import fr.an.com.sun.source.tree.ThrowTree;
import fr.an.com.sun.source.tree.Tree;
import fr.an.com.sun.source.tree.TreeVisitor;
import fr.an.com.sun.source.tree.TryTree;
import fr.an.com.sun.source.tree.TypeCastTree;
import fr.an.com.sun.source.tree.TypeParameterTree;
import fr.an.com.sun.source.tree.UnaryTree;
import fr.an.com.sun.source.tree.UnionTypeTree;
import fr.an.com.sun.source.tree.VariableTree;
import fr.an.com.sun.source.tree.WhileLoopTree;
import fr.an.com.sun.source.tree.WildcardTree;
 ...
 *
 * <p>Except for the methods defined by fr.an.com.sun.source, the only
 ...
 * Tree.
 *
 * <p>To avoid ambiguities with the Tree API in fr.an.com.sun.source all sub
...
public abstract class JCTree implements Tree, Cloneable, DiagnosticPosition {
    ...
    /**
     * implements fr.an.com.sun.source.tree.Tree
     * @since jdk1.8-ARN
     */
    @Override
    ...
    public static class JCNewArray extends JCExpression implements NewArrayTree {
        ...
        public List<? extends ExpressionTree> getDimensions() {
            return (List<? extends ExpressionTree>) dims;
        }
        ...
        public List<? extends AnnotationTree> getAnnotations() {
            return (List<? extends AnnotationTree>) (List) annotations;
        }

        @Override
        public fr.an.com.sun.tools.javac.util.List<? extends fr.an.com.sun.tools.javac.util.List<? extends AnnotationTree>> getDimAnnotations() {
            return (fr.an.com.sun.tools.javac.util.List) dimAnnotations;
        }
    ...
    public static class JCModifiers extends JCTree implements fr.an.com.sun.source.tree.ModifiersTree {
        public long flags;
        public List<JCAnnotation> annotations;
    ...
    public static class JCAnnotatedType extends JCExpression implements fr.an.com.sun.source.tree.AnnotatedTypeTree {
        // type annotations
        public List<JCAnnotation> annotations;
    ...
    public static class JCErroneous extends JCExpression
            implements fr.an.com.sun.source.tree.ErroneousTree {
