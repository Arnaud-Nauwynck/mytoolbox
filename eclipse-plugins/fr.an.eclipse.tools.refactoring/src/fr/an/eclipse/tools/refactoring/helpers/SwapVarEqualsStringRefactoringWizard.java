...
public class SwapVarEqualsStringRefactoringWizard extends RefactoringWizard {

	public SwapVarEqualsStringRefactoringWizard(SwapVarEqualsStringRefactoring ref){
	...
	protected void addUserInputPages(){
		addPage(new SwapVarEqualsStringRefactoringInputPage(""));
	}
}
