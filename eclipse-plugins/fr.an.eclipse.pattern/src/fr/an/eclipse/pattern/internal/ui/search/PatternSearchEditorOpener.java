...
public class PatternSearchEditorOpener {
	...
	private IEditorPart showInEditor(IWorkbenchPage page, IEditorInput input, String editorId) {
		...
		try {
			...
			MessageDialog.openError(JavaPlugin.getActiveWorkbenchShell(), PatternSearchMessages.Search_Error_openEditor_title, PatternSearchMessages.Search_Error_openEditor_message);
			return null;
		}
	}
