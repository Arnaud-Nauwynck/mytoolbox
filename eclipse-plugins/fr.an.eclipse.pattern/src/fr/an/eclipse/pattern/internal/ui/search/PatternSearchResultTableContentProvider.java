...
public class PatternSearchResultTableContentProvider extends PatternSearchContentProvider {
	
	public PatternSearchResultTableContentProvider(PatternSearchResultPage page) {
		super(page);
	}
	
	public Object[] getElements(Object inputElement) {
		if (inputElement instanceof PatternSearchResult) {
			PatternSearchResult patternSearchRes = (PatternSearchResult) inputElement;
			Set<Object> filteredElements= new HashSet<Object>();
			Object[] rawElements= patternSearchRes.getElements();
