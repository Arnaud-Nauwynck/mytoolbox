...
public class PatternSearchResultTreeContentProvider extends PatternSearchContentProvider implements ITreeContentProvider {
	...
	public PatternSearchResultTreeContentProvider(PatternSearchResultPage page, int level) {
		super(page);
		fCurrentLevel= level;
	...
	@Override
	protected synchronized void initialize(PatternSearchResult result) {
	...
	@Override
	public void clear() {
		initialize((PatternSearchResult) getSearchResult());
