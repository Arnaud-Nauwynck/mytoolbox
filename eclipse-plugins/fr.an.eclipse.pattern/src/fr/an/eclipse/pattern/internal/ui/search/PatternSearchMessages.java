...
public final class PatternSearchMessages extends NLS {

	private static final String BUNDLE_NAME= "fr.an.eclipse.pattern.internal.ui.search.PatternSearchMessages";//$NON-NLS-1$
	static {
		NLS.initializeMessages(BUNDLE_NAME, PatternSearchMessages.class);
	}

	private PatternSearchMessages() {
		// Do not instantiate
	}

	public static String PatternSearchResult_label;
	public static String PatternSearchResult_label_singular;
	public static String PatternSearchResult_label_plural;

	
	public static String PatternFileSearchScope_scope_empty;
	public static String PatternFileSearchScope_scope_single;
	public static String PatternFileSearchScope_scope_double;
	public static String PatternFileSearchScope_scope_multiple;

	public static String PatternFileSearchScope_ws_scope_empty;
	public static String PatternFileSearchScope_ws_scope_single;
	public static String PatternFileSearchScope_ws_scope_double;
	public static String PatternFileSearchScope_ws_scope_multiple;
